...
public class placeControllerServlet extends HttpServlet {
	...
	protected void list(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/pages/triplist.jsp");
	...
	protected void detailList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 상세보기, 임시로 triplist 로 설정 

		Object trip = new Object();
		//request.setAttribute("trip", trip); // plan은 임시 데이터 
